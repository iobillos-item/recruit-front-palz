...
export const metadata: Metadata = {
  title: "Terms of Service | RecruitPalz",
  description: "Read RecruitPalz's terms of service for recruitment and hiring automation.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li><strong>Application</strong> refers to the RecruitPalz web application.</li>
              ...
              <li><strong>Service</strong> refers to the RecruitPalz Website and Application.</li>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Acknowledgement</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Disputes Resolution</h2>
            <p className="mb-6">
              If You have any concerns or disputes about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
            </p>

            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">For European Union (EU) Users</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">United States Legal Compliance</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Severability and Waiver</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Translation Interpretation</h2>
            <p className="mb-6">
              These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
            </p>

            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Changes to These Terms and Conditions</h2>
            <p className="mb-6">
            ...
            <p className="mb-2">
              If you have any questions about these Terms of Service, or any questions, complaints, or claims with respect to the Application, you can contact RecruitPalz's support team at:
            </p>
